...
import type { ContainerApp, Dapr } from "@azure/arm-appcontainers";
...
export class DaprEnabledItem implements TreeElementBase {
	...
	constructor(
		private readonly containerApp: ContainerAppModel,
		private readonly dapr: Dapr,
	) {}

	id = `${this.containerApp.id}/DaprEnabled`;
...
export function createDaprDisabledItem(
