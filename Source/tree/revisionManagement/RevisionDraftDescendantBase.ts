 ...
 */
export abstract class RevisionDraftDescendantBase
	implements RevisionsItemModel, RevisionsDraftModel
{
	...
	static createTreeItem<T extends RevisionDraftDescendantBase>(
		RevisionDraftDescendant: DescendantConstructor<T>,
		subscription: AzureSubscription,
		containerApp: ContainerAppModel,
		revision: Revision,
		...args: unknown[]
	): T {
		const descendant: T = new RevisionDraftDescendant(
			subscription,
			containerApp,
			revision,
			...args,
...
type DescendantConstructor<T extends RevisionDraftDescendantBase> = {
	new (
		subscription: AzureSubscription,
		containerApp: ContainerAppModel,
		revision: Revision,
