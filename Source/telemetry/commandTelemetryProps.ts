...
export interface DeployImageApiTelemetryProps
	extends ImageSourceTelemetryProps,
		OverwriteConfirmTelemetryProps {
	revisionMode?: KnownActiveRevisionsMode;
}

export interface DeployRevisionDraftTelemetryProps
...
export interface ContainerUpdateTelemetryProps
	extends AzdTelemetryProps,
...
export type CreateContainerAppTelemetryProps = ImageSourceTelemetryProps &
	AzdTelemetryProps &
