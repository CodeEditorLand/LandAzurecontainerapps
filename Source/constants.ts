...
export namespace IngressConstants {
	...
	export const externalDesc: string = localize(
		"externalDesc",
		"Accepting traffic from anywhere",
	);

	export const internalDesc: string = localize(
		"internalDesc",
		"Only allowing traffic within your vNet",
	);
}

export namespace RevisionConstants {
	export const multiple: IAzureQuickPickItem<string> = {
	...
	export const single: IAzureQuickPickItem<string> = {
		label: localize("single", "Single"),
		description: localize("singleDesc", "One active revision at a time"),
		data: "single",
	};
}

export const currentlyDeployed: string = localize(
	"currentlyDeployed",
	"(currently deployed)",
);

export const showDraftCommandDeployPopupSetting: string =
...
export const browseItem: IAzureQuickPickItem<undefined> = {
	label: `$(file-directory) ${localize("browse", "Browse...")}`,
	description: "",
	data: undefined,
};
