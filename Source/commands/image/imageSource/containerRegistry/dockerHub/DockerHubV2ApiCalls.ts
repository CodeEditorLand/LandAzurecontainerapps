...
import {
	type DockerHubV2ApiResponse,
	type DockerHubV2Repository,
	type DockerHubV2Tags,
} from "./DockerHubV2Types";

export async function getReposForNamespace(
...
export async function getTagsForRepo(
	...
	name: string,
	nextUrl?: string | null,
): Promise<DockerHubV2ApiResponse<DockerHubV2Tags>> {
	const url =
		nextUrl ||
