...
import {
	type DeployWorkspaceProjectInternalContext,
	deployWorkspaceProjectInternal,
} from "./internal/deployWorkspaceProjectInternal";

// Todo: Replace existing deployWorkspaceProject command once completed, and get rid of the V2 in the name
export async function deployWorkspaceProjectV2(
	...
	const subscription: AzureSubscription = await subscriptionExperience(
		context,
	...
	const deployWorkspaceProjectResultContext: DeployWorkspaceProjectContext =
	...
	return await getDeployWorkspaceProjectResults(
		deployWorkspaceProjectResultContext,
	);
}
