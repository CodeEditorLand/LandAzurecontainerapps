...
import {
	getContainerAppResourcesFromItem,
	getContainerAppResourcesFromSettings,
} from "./getDefaultResourcesFrom";
...
export async function getDefaultContainerAppsResources(
	...
	const { resourceGroup, managedEnvironment, containerApp } =
		await getContainerAppResourcesFromSettings(context, settings);
