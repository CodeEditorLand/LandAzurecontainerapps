...
import { type WorkspaceFolder, commands } from "vscode";
...
export async function getWorkspaceProjectRootFolder(
	...
	const prompt: string = localize(
		"selectRootWorkspace",
		"Select a project with a Dockerfile",
	);
	const rootFolder: WorkspaceFolder | undefined =
		await getRootWorkspaceFolder(prompt);
