...
export async function editContainerImage(
	context: IActionContext,
	node?: ImageItem,
): Promise<void> {
	const item: ImageItem =
		node ?? (await pickImage(context, { autoSelectDraft: true }));
	...
	const wizard: AzureWizard<ContainerEditUpdateContext> = new AzureWizard(
		wizardContext,
		{
			title: localize(
				"editContainerImage",
