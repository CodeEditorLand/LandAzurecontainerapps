...
export class ContainerAppCreateStep extends ExecuteActivityOutputStepBase<CreateContainerAppContext> {
	...
	protected async executeCore(
		context: CreateContainerAppContext,
		progress: Progress<{
			...
			await appClient.containerApps.beginCreateOrUpdateAndWait(
				...
				containerAppName,
				{
					...
					managedEnvironmentId:
						context.managedEnvironmentId ||
						context.managedEnvironment?.id,
					configuration: {
						ingress,
		...
		return {
			item: new GenericTreeItem(undefined, {
				contextValue: createActivityChildContext([
					"containerAppCreateStepSuccessItem",
					activitySuccessContext,
				]),
				label: localize(
					"createContainerApp",
	...
	protected createFailOutput(
		...
		return {
			item: new GenericParentTreeItem(undefined, {
				contextValue: createActivityChildContext([
					"containerAppCreateStepFailItem",
					activityFailContext,
				]),
				label: localize(
					"createContainerApp",
