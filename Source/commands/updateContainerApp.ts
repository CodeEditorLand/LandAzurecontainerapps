...
export async function updateContainerApp(
	...
	updatedSetting?: Omit<ContainerApp, "location">,
	...
	const resourceGroupName = getResourceGroupFromId(
	...
	const updatedApp: ContainerApp = !updatedSetting
		? containerApp
		: { ...updatedSetting, location: containerApp.location };
