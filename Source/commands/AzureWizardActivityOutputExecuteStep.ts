...
export abstract class AzureWizardActivityOutputExecuteStep<
...
> extends AzureWizardExecuteStep<T> {
	...
	public createSuccessOutput(context: T): ExecuteActivityOutput {
		...
		return createExecuteActivityOutput(context, {
			...
			treeItemLabel: this.getTreeItemLabel
				? this.getTreeItemLabel(context)
				: success,
...
function createExecuteActivityOutput(
	_: IActionContext,
	options: ActivityOutputCreateOptions,
