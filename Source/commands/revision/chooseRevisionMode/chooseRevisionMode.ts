...
export async function chooseRevisionMode(
	context: IActionContext,
	item?: ContainerAppItem | RevisionsItem,
): Promise<void> {
	...
	const wizard: AzureWizard<IChooseRevisionModeContext> = new AzureWizard(
		wizardContext,
		{
			title: localize(
				"changeRevisionModeTitle",
				"Change container app revision mode.",
			),
			promptSteps,
			executeSteps,
		},
